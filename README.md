...
**Description:** A collection of fundamental NLP text preprocessing notebooks covering tokenization, stopword removal, stemming, lemmatization, POS tagging, and named entity recognition.
### Project 4: [Employee Churn Prediction System (ANN)](https://github.com/MoosaMemon/ML-DL-NLP-CV-Projects/tree/main/Churn%20Modeling%20(ANN))
**Description:** Uses an Artificial Neural Network (ANN) to predict employee churn based on employee-related features through data preprocessing and model training.
### Project 5: [Pima Indians Diabetes Prediction System (ANN)](https://github.com/MoosaMemon/ML-DL-NLP-CV-Projects/tree/main/Pima%20Indians%20Diabetes%20(ANN))
**Description:** Applies an Artificial Neural Network (ANN) to predict diabetes onset using medical diagnostic data.
